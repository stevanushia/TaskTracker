        ...
        <aside class="w-64 bg-[#1E293B] text-white flex flex-col justify-between">
            <div>
                ...
                <nav class="mt-2 space-y-1 px-3">
                    <router-link :to="{ name: 'dashboard' }"
                        ...
                        active-class="bg-gray-800/50 text-white" exact-active-class="bg-gray-800/50 text-white">
                        <span class="mr-3">📊</span> Dashboard
                    </router-link>
                    <router-link :to="{ name: 'projects' }"
                        class="flex items-center px-3 py-2.5 rounded-lg text-sm font-medium text-gray-400 hover:text-white hover:bg-gray-800 transition"
                        active-class="bg-gray-800/50 text-white">
            ...
            <div class="p-4 border-t border-gray-700">
                <button @click="handleLogout"
                    class="flex items-center w-full px-3 py-2 mb-4 text-sm font-medium text-gray-400 hover:text-white transition">
